#!/usr/bin/env bash
_location=".config/yadm/scripts/install-xorg.sh"

# This script is for installing Xorg on Fedora.  This is often a desirable step
# to take before running the main bootstrap script.  The bootstrap script will
# prepare either a shell only environment or an Xorg based workstation
# depending on whether or not Xorg is installed.  So running this first will
# ensure a workstation installation occurs.
